...
public class ConcMark extends Concurrent {
  ...
  public static final MarkRegionSpace markRegionSpace = new MarkRegionSpace("mr", VMRequest.discontiguous());
  public static final int CONC_MARK = markRegionSpace.getDescriptor();
  ...
  static {
    ...
    //markRegionSpace.makeAllocAsMarked();
  ...
  public static final int SCAN_RELOCATE = 0;
  ...
  protected boolean concurrentCollectionRequired() {
    return !Phase.concurrentPhaseActive() && (getPagesAvail() <= Math.round(getTotalPages() * Options.defragHeadroomFraction.getValue()));
  }
  ...
  public boolean willNeverMove(ObjectReference object) {
    if (Space.isInSpace(CONC_MARK, object)) return true;
