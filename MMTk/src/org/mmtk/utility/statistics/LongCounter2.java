 ...
 */
@Uninterruptible
public class LongCounter2 extends Counter {
...
//  protected long count = 0;
   ...
   */
  public LongCounter2(String name) {
   ...
   */
  public LongCounter2(String name, boolean start) {
   ...
   */
  public LongCounter2(String name, boolean start, boolean mergephases) {
    this(name, start, mergephases, false);
  }

  public LongCounter2(String name, boolean start, boolean mergephases, boolean reportMean) {
